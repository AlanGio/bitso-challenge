...
describe('Util tests', () => {
  describe('loadItems function', () => {
    it('should return an only sea 4x4 map', () => {
      ...
      const loadedItems = loadItems(mockedParametersData.columns, mockedParametersData.rows, []);
    ...
    it('should return a two islands 5x5 map', () => {
      ...
      const loadedItems = loadItems(mockedParametersData.columns, mockedParametersData.rows, mockedParametersData.grid);
  ...
  describe('detectIslands function', () => {
    ...
    it('should count 0 islands', () => {
      ...
      const newRowReturn = detectIslands(mockedColumns, mockedRows, mockOnlySeaMap);
    ...
    it('should count 2 islands', () => {
      ...
      const newRowReturn = detectIslands(mockedColumns, mockedRows, mockMapWithIslandsMap);
